...
public record ConcertOptionCreateInfo(
	...
	public static ConcertOptionCreateInfo from(ConcertOption concertOption) {
		return ObjectMapperBasedVoMapper.convert(concertOption, ConcertOptionCreateInfo.class);
	}
}
