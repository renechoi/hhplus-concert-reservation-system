package io.redisservice.common.alert.listener;



import static io.redisservice.common.alert.client.messageservice.dto.SlackMessageReserveRequest.*;

import org.springframework.context.event.EventListener;
import org.springframework.scheduling.annotation.Async;

import io.redisservice.common.alert.GlobalExceptionAlertEvent;
import io.redisservice.common.alert.client.messageservice.MessageServiceClientAdapter;
import io.redisservice.common.annotation.InternalListener;
