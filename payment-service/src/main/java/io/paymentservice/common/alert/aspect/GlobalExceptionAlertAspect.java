package io.paymentservice.common.alert.aspect;
...
import io.paymentservice.common.alert.publisher.GlobalExceptionAlertInternalPublisher;
...
public class GlobalExceptionAlertAspect {
	...
	@Pointcut("execution(public * io.queuemanagement.api..*(..))")
	void apiMethods() {
	}
