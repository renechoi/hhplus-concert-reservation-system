package io.messageservice.common.logtrace.impl;
...
import io.messageservice.common.logtrace.LogTracer;
import io.messageservice.common.logtrace.TraceStatus;
...
public class GlobalTraceHandler {
	...
	@Pointcut("execution(* io.messageservice.api..*(..)) ")
	public void all() {
	}
